...
- 当前分支：codex/vedio，提交 9ceab5d3ae7ef9fa16f0c9d7b9fe99a057e2f8c8。
...
脚本要求两个分支仍停在上述提交，且除 merge-review/ 外没有其他工作区修改；不满足就停止。
执行内容：开始本地 merge --no-commit、应用已验证的 10 份解决文件、运行测试与构建、暂存已解决路径、创建本地合并提交。**不修改 .env，不推送远程，不提交本辅助目录。**
